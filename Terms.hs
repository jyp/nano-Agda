...
instance (P.Pretty a, P.Pretty b) => P.Pretty (TLoc' a b) where
    pretty t =
        case t of
          ...
          Fin i s l t' ->
               P.letP (P.vartype i s) (P.finP l) (P.pretty t')
